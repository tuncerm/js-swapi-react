      ...
      <CacheContext.Provider value={{ getData }}>
        <Router>
          ...
          <Switch>
            ...
            <Route path="/people/:peopleId" exact><Character /></Route>
            <Route path="/planets" exact><Planets /></Route>
            <Route path="/planets/:planetId" exact><Planet /></Route>
            <Route path="/species" exact><Species /></Route>
            <Route path="/species/:specieId" exact><Specie /></Route>
            <Route path="/starships" exact><StarShips /></Route>
            <Route path="/starships/:starShipId" exact><StarShip /></Route>
            <Route path="/vehicles" exact><Vehicles /></Route>
            <Route path="/vehicles/:vehicleId" exact><Vehicle /></Route>
            <Redirect to="/" />
          </Switch>
        </Router>
